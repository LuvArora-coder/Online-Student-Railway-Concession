    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body my-5 pt-4">
                ...
                <form action="afterlogin.jsp?Rfid="'+rfid+"'">
                    <div class="form-group">
                        <label class="col-form-label">Scan Rfid</label>
                        <input type="rfid" class="form-control" placeholder="your name" name="username" required="">
                    </div>
