...
<body>
        ...
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body my-5 pt-4">
                ...
                <form action="../adminlogin" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-form-label"><font color="white">Password</font></label>
                    ...
                    <div class="row sub-w3l mt-3 mb-5">
                        <div class="col-sm-6 sub-w3layouts_hub">
                            <input type="checkbox" id="brand1" value=""> <font color="white">Remember me</font>
                            <label for="brand1" class="text-li text-style-w3ls">
                   
                        </div>
                        <div class="col-sm-6 forgot-w3l text-sm-right">
                            <a href="#" class="text-li text-style-w3ls"><font color="black">Forgot Password?</font></a>
                        </div>
                    </div>
            ...
            <div class="row footer-grids">
                ...
                <div class="col-lg-2 col-6 footer-grid footer-contact mt-lg-0 mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="mailto:info@example.com">sanket.bhos@somaiya.edu</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4 footer-grid mt-lg-0 mt-4">
                    <div class="footer-logo">
                        <h2 class="text-lg-center text-center">
                            <img src="images/asrc.jpg" height="150" width="250">
                        </h2>
                    </div>
                </div>
            </div>
    ...
    <div class="copyright-w3ls py-4">
        <div class="container">
            <div class="row">
                <!-- copyright -->
                <p class="col-lg-8 copy-right-grids text-wh text-lg-left text-center mt-lg-2">© 2020 KJSP. All
                    Rights Reserved | Design by KJSP
                </p>
                <!-- //copyright -->
                <!-- social icons -->
